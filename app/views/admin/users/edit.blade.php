...
@section('main')
	{{ Form::model($user, array('method'	=>	'PATCH',	'route'	=>	array('admin.users.update',	$user->id), 'class'	=>	'form-horizontal', 'role'	=>	'form')) }}
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<label>
					{{ Form::checkbox('verified', '1', Input::old('verified', boolval($user->verified)), array('class'	=>	'ace ace-switch ace-switch-2')) }}
					<span class="lbl"></span>
				</label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<label>
					{{ Form::checkbox('disabled', '1', Input::old('disabled', boolval($user->disabled)), array('class'	=>	'ace ace-switch ace-switch-2')) }}
					<span class="lbl"></span>
				</label>
			</div>
		</div>
		...
		<div class="clearfix form-actions">
			<div class="col-md-offset-3 col-md-9">
				...
				{{ HTML::decode(link_to_route('admin.users.show', '<i class="icon-remove bigger-110"></i>取消', $user->id, array('class' => 'btn'))) }}
			</div>
		</div>
	{{ Form::close() }}
@stop